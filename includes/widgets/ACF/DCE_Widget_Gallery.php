...
class DCE_Widget_Gallery extends DCE_Widget_Prototype {
    ...
    public function get_title() {
        return __('ACF Gallery', DCE_TEXTDOMAIN);
    }

    public function get_description() {
        return __('Use a list of elements generated by an ACF field Gallery considering different ways to use it', DCE_TEXTDOMAIN);
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'groups' => DCE_Helper::get_all_acf(true,'gallery'),
        ...
        $this->add_control(
                'gallery_type', [
            'label' => __('Gallery Type', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SELECT,
            'options' => [
                'row' => __('Row', DCE_TEXTDOMAIN),
                'grid' => __('Grid', DCE_TEXTDOMAIN),
                'masonry' => __('Masonry', DCE_TEXTDOMAIN),
                'single_image' => __('Single image', DCE_TEXTDOMAIN),
                'diamond' => __('Diamond', DCE_TEXTDOMAIN),
                'hexagon' => __('Hexagon', DCE_TEXTDOMAIN),
            ],
            'default' => 'masonry',
        ...
        $this->add_responsive_control(
                'columns_grid', [
            'label' => __('Items per row', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SELECT,
            'default' => '2',
            'tablet_default' => '3',
            'mobile_default' => '1',
        ...
        $this->add_control(
                'column_diamond', [
            'label' => __('Min Diamond per Row', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SELECT,
            'default' => '4',
            'options' => [
                '1' => '1',
        ...
        /* $this->add_responsive_control(
          'gap_diamond', [
          'label' => __('Gap Diamond', DCE_TEXTDOMAIN),
          'type' => Controls_Manager::SLIDER,
          'default' => [
          'size' => '',
          'unit' => 'px',
        ...
        $this->add_control(
                'hideIncompleteRow', [
            'label' => __('Hide Incomplete Row', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SWITCHER,
            'frontend_available' => true,
            'condition' => [
                'gallery_type' => 'diamond',
        ...
        $this->add_responsive_control(
                'size_honeycombs', [
            'label' => __('Size Hexagon', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::NUMBER,
            'default' => 250,
            'tablet_default' => 150,
            'mobile_default' => 100,
        ...
        $this->add_control(
                'gap_honeycombs', [
            'label' => __('Gap Hexagon', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::NUMBER,
            'default' => 10,
            'min' => 0,
            'max' => 100,
        ...
        $this->add_responsive_control(
                'items_padding', [
            'label' => __('Paddings Items', DCE_TEXTDOMAIN),
        ...
        $this->add_control(
            ...
            'description' => __('Select what to use in the description below the image', DCE_TEXTDOMAIN),
        ...
        /* $this->add_control(
          ...
          'label' => __('Enable Effects', DCE_TEXTDOMAIN),
          'type' => Controls_Manager::SWITCHER,
          'default' => '',
          'label_on' => __('Yes', DCE_TEXTDOMAIN),
          'label_off' => __('No', DCE_TEXTDOMAIN),
          ...
          'selectors' => [
          '{{WRAPPER}} .wrap-item-acfgallery' => 'opacity: {{SIZE}};',
          ],
          'condition' => [
          ...
          'selectors' => [
          '{{WRAPPER}} .wrap-item-acfgallery' => '-webkit-transform: rotate({{SIZE}}{{UNIT}}); -moz-transform: rotate({{SIZE}}{{UNIT}}); -ms-transform: rotate({{SIZE}}{{UNIT}}); -o-transform: rotate({{SIZE}}{{UNIT}}); transform: rotate({{SIZE}}deg);',
          ],
          'condition' => [
          'enable_image_effects' => 'yes',
          ]
        ...
        $this->add_control(
                ...
                [
                    'label' => __('Caption', DCE_TEXTDOMAIN),
                    'type' => Controls_Manager::HEADING,
                    'separator' => 'before',
                    'condition' => [
                        'use_desc' => 'caption',
        ...
        $this->add_control(
            ...
            'label' => __('Image link', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SWITCHER,
            'condition' => [
                'enable_lightbox' => '',
            ]
        ...
        $this->start_controls_section(
            ...
            'label' => 'Image Link', DCE_TEXTDOMAIN,
            'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
    ...
    protected function render() {
        ...
        //$text_before = __($settings['acf_text_before'], DCE_TEXTDOMAIN.'_texts');
        //
            ...
            if (is_array($first_image)) {
                ...
                if (filter_var(reset($galleria), FILTER_VALIDATE_URL)) {
                    ...
                    foreach ($galleria as $image_url) {
                        $tmp[] = DCE_Helper::get_image_id($image_url);
                    }
                    $galleria = $tmp;
                }
        ...
        if ($galleria):
            ...
            //echo $text_before;
            ?>
            <div class="<?php echo $type_gallery; ?>-grid dynamic_acfgallery dynamic_acfgallery-<?php echo $type_gallery . $enable_lightbox . $elementor_lightbox . $lightbox_type . $overlay_hover_class; ?> column-<?php echo $settings['columns_grid']; ?>" itemscope itemtype="http://schema.org/ImageGallery">
                <?php
                foreach ($galleria as $image):
