...
class DCE_Widget_Slider extends DCE_Widget_Prototype {
    ...
    public function get_title() {
        return __('ACF Slider', DCE_TEXTDOMAIN);
    }
    public function get_description() {
      return __('Use a list of elements generated by an ACF field gallery and create a slider or a carousel of images', DCE_TEXTDOMAIN);
    }
    ...
    public function get_script_depends() {
        return ['photoswipe', 'photoswipe-ui', 'imagesloaded', 'jquery-slick', 'dce-acfslider'];
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_content', [
              'label' => __('ACF Slider', DCE_TEXTDOMAIN),
            ]
        );
        $this->add_control(
          'acf_field_list', [
        ...
        $this->add_control(
          'force_height', [
            'label' => __('Force Height', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SWITCHER,
            'default' => '',
            'label_on' => __('Yes', DCE_TEXTDOMAIN),
            'label_off' => __('No', DCE_TEXTDOMAIN),
        ...
        $this->add_control(
          'use_bg_image', [
            'label' => __('Use as a background image and not as an img tag.', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SWITCHER,
            'default' => '',
            'label_on' => __('Yes', DCE_TEXTDOMAIN),
            'label_off' => __('No', DCE_TEXTDOMAIN),
        ...
        $this->add_responsive_control(
          'height_bg_img', [
            'label' => __('Background Height', DCE_TEXTDOMAIN),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px','vh' ],
                'default' => [
                    'unit' => 'px',
        ...
        $this->add_responsive_control(
          'spaceV', [
            'label' => __('Vertical space', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => '',
                'unit' => 'px',
        ...
        $this->add_control(
          'use_desc', [
            'label' => __('Description', DCE_TEXTDOMAIN),
            'description' => __('Select what to use in the description.', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SELECT,
            'options' => [
                '' => __('None', DCE_TEXTDOMAIN),
                'caption' => __('Caption',DCE_TEXTDOMAIN),
        ...
        $this->add_control(
          'enable_image_style', [
            'label' => __('Enable Style', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SWITCHER,
            'default' => '',
            'label_on' => __('Yes', DCE_TEXTDOMAIN),
            'label_off' => __('No', DCE_TEXTDOMAIN),
        ...
        $this->start_controls_section(
          'section_swiper_settings', [
            'label' => __('Slider Settings', DCE_TEXTDOMAIN),
          ]
        );
        
        $this->add_control(
          'effects', [
            'label' => __('Tranisition effect', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SELECT,
            'options' => [
        ...
        $this->add_responsive_control(
          'navigation_size', [
            'label' => __('Navigation size', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => '48',
                'unit' => 'px',
        ...
        $this->add_responsive_control(
          'navigation_scale', [
            'label' => __('Arrows scale', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => '1',
                'unit' => 'px',
        ...
        $this->add_responsive_control(
          'navigation_position', [
            'label' => __('Horizontal position', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => '10',
                'unit' => 'px'
        ...
        $this->add_responsive_control(
          'vertical_navigation_position', [
            'label' => __('Vertical position', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => 50,
                'unit' => '%'
        ...
        $this->add_control(
          'navigation_arrow_color_hover', [
            'label' => __('Arrow color hover', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::COLOR,
        ...
        $this->add_control(
          'usePagination', [
            ...
            'description' => __('If yes, you will use the system of visualization of the progression of the slides ("bullets", "fraction", "progress")', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SWITCHER,
            'default' => 'yes',
            'label_on' => __('Yes', DCE_TEXTDOMAIN),
            'label_off' => __('No', DCE_TEXTDOMAIN),
        ...
        $this->add_control(
          'fraction_separator', [
              ...
              'description' => __('Il testo che separ i 2 numeri', DCE_TEXTDOMAIN),
        ...
        $this->add_control(
          'fraction_color', [
            'label' => __('Numbers color', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::COLOR,
        ...
        $this->add_group_control(
          Group_Control_Typography::get_type(), [
            ...
            'label' => __('Numbers Typography', DCE_TEXTDOMAIN),
        ...
        $this->add_group_control(
          Group_Control_Typography::get_type(), [
            ...
            'label' => __('Typography current number', DCE_TEXTDOMAIN),
            'default' => '',
        ...
        $this->add_group_control(
          Group_Control_Typography::get_type(), [
            ...
            'label' => __('Separator Typography',DCE_TEXTDOMAIN),
            'default' => '',
        ...
        $this->add_responsive_control(
          'pagination_bullets', [
            'label' => __('Bullets size', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => '8',
                'unit' => 'px',
        ...
        /* $this->add_responsive_control(
          'current_bullet', [
            'label' => __('La dimensione del pallino attivo', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SLIDER,
            'default' => [
                'size' => '',
                'unit' => 'px',
        ...
        $this->start_controls_section(
          'section_swiper_scrollbar', [
            'label' => __('Scrollbar', DCE_TEXTDOMAIN),
          ]
        );
        // -------------------------------- Scrollbar options ------
        $this->add_control(
        ...
        $this->add_control(
          'freeModeMomentumBounceRatio', [
            ...
            'description' => __('Higher value produces bigger rebound effect of the moment', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::NUMBER,
            'default' => 1,
            'min' => 0,
            'max' => 10,
        ...
        $this->start_controls_section(
          'section_swiper_special', [
            'label' => __('Other Options', DCE_TEXTDOMAIN),
          ]
        );
        // -------------------------------- Special options ---------
        $this->add_control(
        ...
        $this->add_control(
          'nested', [
            'label' => __('Nested', DCE_TEXTDOMAIN),
        ...
        $this->start_controls_section(
            'section_lightbox_effects', [
              'label' => 'Lightbox Settings', DCE_TEXTDOMAIN,
              'condition' => [
              //'acf_type' => ['gallery'],
              ]
            ]
        ...
        $this->add_control(
            'enable_lightbox', [
              'label' => __('Enable LightBox', DCE_TEXTDOMAIN),
              'type' => Controls_Manager::SWITCHER,
              'default' => '',
              'label_on' => __('Yes', DCE_TEXTDOMAIN),
              'label_off' => __('No', DCE_TEXTDOMAIN),
        ...
        $this->add_control(
            'lightbox_type', [
                'label' => __('Lightbox Type', DCE_TEXTDOMAIN),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => __('Default', DCE_TEXTDOMAIN),
        ...
        $this->add_control(
         'enable_overlay_hover', [
            'label' => __('Overlay Hover', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SWITCHER,
            'default' => '',
            'label_on' => __('Yes', DCE_TEXTDOMAIN),
            'label_off' => __('No', DCE_TEXTDOMAIN),
      ...
      $this->add_group_control(
        ...
        $this->add_control(
            'hover_effects', [
                'label' => __('Hover Effects', DCE_TEXTDOMAIN),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => __('None', DCE_TEXTDOMAIN),
        ...
        /*$this->start_controls_section(
                'section_style', [
            'label' => sprintf(
                    __('STYLE', DCE_TEXTDOMAIN), $post_type_object->labels->singular_name
            ),
