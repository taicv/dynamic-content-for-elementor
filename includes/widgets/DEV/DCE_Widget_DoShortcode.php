...
class DCE_Widget_DoShortcode extends DCE_Widget_Prototype {
    ...
    public function get_title() {
        return __('DoShortcode', DCE_TEXTDOMAIN);
    }
    public function get_description() {
        return __('Apply a WordPress shortcode', DCE_TEXTDOMAIN);
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
                'section_doshortcode', [
                'label' => __('DoShortcode', DCE_TEXTDOMAIN),
            ]
        );
       $this->add_control(
          'doshortcode_string',
          [
             'label'   => __( 'Shortcode', DCE_TEXTDOMAIN ),
