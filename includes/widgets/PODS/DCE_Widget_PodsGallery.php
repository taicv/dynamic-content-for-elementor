...
class DCE_Widget_PodsGallery extends DCE_Widget_Prototype {
    ...
    public function get_title() {
        return __('PODS Gallery', DCE_TEXTDOMAIN);
    }

    public function get_description() {
        return __('Use a list of elements generated by a PODS field Image considering different ways to use it', DCE_TEXTDOMAIN);
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
                'section_content', [
            'label' => 'PODS', DCE_TEXTDOMAIN,
                ]
        );

        $this->add_control(
                'gallery_field_list', [
            'label' => __('PODS Field', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SELECT,
            'groups' => DCE_Helper::get_pods_field('file'),
        ...
        $this->add_control(
                'enabled_wow', [
            'label' => __('Enable Animation', DCE_TEXTDOMAIN),
            'type' => Controls_Manager::SWITCHER,
            'default' => '',
