...
class DCE_Widget_PopUp extends DCE_Widget_Prototype {
    ...
    protected function _register_controls() {
       ...
       /* $this->add_control(
        ...
        $this->add_control(
            'hamburger_style', [
                'label' => __('Hamburger Type', DCE_TEXTDOMAIN),
                'type' => Controls_Manager::SELECT,
                'default' => 'x',
                'options' => [
        ...
        */
        ...
        $this->add_control(
            'modal_align', [
                'label' => __('Horizontal alignment', DCE_TEXTDOMAIN),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
        ...
        $this->add_control(
            'extend_full_window', [
                'label' => __('Extend Full Window', DCE_TEXTDOMAIN),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
                'label_on' => __('Yes', DCE_TEXTDOMAIN),
                'label_off' => __('No', DCE_TEXTDOMAIN),
        ...
        $this->add_responsive_control(
            'hamburger_size', [
                'label' => __('Hamburger Size', DCE_TEXTDOMAIN),
                'type' => Controls_Manager::SLIDER,
                'separator' => 'before',
                'default' => [
                    'size' => 50,
        ...
        $this->add_control(
            'hamburger_weight', [
                'label' => __('Hamburger weight', DCE_TEXTDOMAIN),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 5,
                    'unit' => 'px',
        ...
        */
        $this->add_control(
            'hamburger_space', [
                'label' => __('Hamburger space', DCE_TEXTDOMAIN),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 10,
                    'unit' => 'px',
        ...
        $this->add_control(
            'x_close_text_color', [
                'label' => __('X color', DCE_TEXTDOMAIN),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
