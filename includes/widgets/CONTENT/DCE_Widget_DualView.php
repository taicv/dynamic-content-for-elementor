...
class DCE_Widget_DualView extends DCE_Widget_Prototype {
    ...
    public function get_title() {
        return __('Dual View', DCE_TEXTDOMAIN);
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'page_parent', 
            [
                'label' => __('Enabled ParentChild Options', DCE_TEXTDOMAIN),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
                'label_on' => __('Yes', DCE_TEXTDOMAIN),
                'label_off' => __('No', DCE_TEXTDOMAIN),
...
$this->add_control(
    ...
    protected function render() {
        ...
        if(is_singular()){
            ...
            if($settings['exclude_io'] == 'yes') $exclude_io = array( $id_page );
        }else if( is_home() || is_archive() ){
            $exclude_io = array();
        }
        
        if($settings['exclude_posts']) $posts_excluded = $settings['exclude_posts'];
        ...
        if( $settings['query_type'] == 'specific_posts'){
            ...
            if( 'elementor_library' == $type_page) $type_page = 'post';
            $args = array(  
                'post_type'         => $type_page,
