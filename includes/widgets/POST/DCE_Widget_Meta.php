    ...
    protected function _register_controls() {
        ...
        */
        ...
        $this->add_control(
                ...
                [
                    'label' => __('Text Length', DCE_TEXTDOMAIN),
        ...
        $this->add_control(
                ...
                [
                    'label' => __('Text Ellipsis', DCE_TEXTDOMAIN),
                    'type' => \Elementor\Controls_Manager::TEXT,
                    'description' => __('Will substitute the part of the content that is omitted in text.', DCE_TEXTDOMAIN),
                    'default' => '&hellip;',
                    'condition' => [
                        'dce_meta_text_length!' => '',
                    ],
    ...
    protected function render() {
        ...
        if (!empty($meta_values)) {
            ...
            foreach ($meta_values as $mkey => $meta_value) {
                ...
                $original_type = $meta_type = DCE_Helper::get_post_meta_type($meta_key, $meta_value);
                ...
                switch ($render_type) {
                    ...
                    case 'text':
                        ...
                        if ($settings['dce_meta_text_strip_tags']) {
                            $allowed_tags = DCE_Helper::str_to_array(',', $settings['dce_meta_text_allowed_tags'], 'strtolower');
                        ...
                        if ($settings['dce_meta_text_length']) {
                            $meta_html = DCE_Helper::text_reduce($meta_html, $settings['dce_meta_text_length'], $settings['dce_meta_text_length_type'], $settings['dce_meta_text_finish']);
