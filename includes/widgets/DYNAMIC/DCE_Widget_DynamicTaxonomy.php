...
class DCE_Widget_DynamicTaxonomy extends DCE_Widget_Prototype {
    ...
    public function get_title() {
        return __('Dynamic Taxonomy', DCE_TEXTDOMAIN);
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
                ...
                'label' => __('dynamic-taxonomy', DCE_TEXTDOMAIN),
            ]
        );
        $this->add_control(
          ...
          [
             ...
             'raw' => __( '<div>Questo è un widget che diventerà un\'dynamic-taxonomy.</div>', DCE_TEXTDOMAIN ),
